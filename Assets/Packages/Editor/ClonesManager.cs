...
namespace ParrelSync
{
    ...
    public class ClonesManager
    {
        ...
        private static string GetApplicationPath()
        {
            ...
            {
                RuntimePlatform.WindowsEditor => EditorApplication.applicationPath,
                RuntimePlatform.OSXEditor => EditorApplication.applicationPath + "/Contents/MacOS/Unity",
                RuntimePlatform.LinuxEditor => EditorApplication.applicationPath,
                _ => throw new System.NotImplementedException("Platform has not supported yet ;("),
            };
        }
        ...
        public static string GetOriginalProjectPath()
        {
            if (IsClone())
            {
                ...
                if (index > 0)
                {
                    string originalProjectPath = cloneProjectPath[..index];
