...
namespace ParrelSync
{
    ...
    {
        private static readonly string serializationToken = "|||";
        public string Key { get; private set; }
    ...
    public class Preferences : EditorWindow
    {
        ...
        /// </summary>
        public static BoolPreference AlsoCheckUnityLockFileStaPref = new("ParrelSync_CheckUnityLockFileOpenStatus", true);
        ...
        /// </summary>
        public static ListOfStringsPreference OptionalSymbolicLinkFolders = new("ParrelSync_OptionalSymbolicLinkFolders");
